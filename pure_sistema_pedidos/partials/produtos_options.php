<div id="item-container">
    ...
    <div class="item-block">
        <div class="row mb-3">
            ...
            <div class="col-md-6">
                <label>Produto:</label>
                <select size='1' class='form-control' name='produto[]' id='produto' required>
                    <option hidden disabled selected value>Selecione...</option>
                    <!-- VENDA -->
                    <div class="filterDiv filterVenda">
                    ...
                    <!-- CONTRATO -->
                    <div class="filterDiv filterContrato">
        ...
        <div class="row mb-3 filterDiv filterVenda">
            <div class="col-md-3">
        ...
        <div class="row mb-3 filterDiv filterContrato">
            <div class="col-md-3">
...
<script>
    ...
    //     var categoriaSelects = document.querySelectorAll("[name='categoria[]']");

    //     categoriaSelects.forEach(function(select) {
    //         select.addEventListener("change", function() {
    //             var selectedOption = select.options[select.selectedIndex];
    //             var dataReference = selectedOption.getAttribute("data-reference");
    //             var itemBlock = select.closest('.item-block');

    //             // Esconder todas as divs com data-belongsto diferente do data-reference selecionado no bloco atual
    //             var belongsToDiv = itemBlock.querySelector("[data-belongsto='" + dataReference + "']");
    //             var allBelongsToDivs = itemBlock.querySelectorAll("[data-belongsto]");
    //             allBelongsToDivs.forEach(function(div) {
    //                 if (div === belongsToDiv) {
    ...
    const categorias = document.querySelectorAll("[name='categoria[]']");
    console.log(categorias[1].value);
    categorias.forEach((el) => {
        el.addEventListener("input", (e) => {
            ...
            // if (el.value == "Venda") {
            //     filterSelection("filterVenda");
            // } else if (el.value == "Contrato") {
            //     filterSelection("filterContrato");
            // }
        })
    })

    for (var i = 0; i < categorias.length; i++) {
        categorias[i].addEventListener("change", function() {
            console.log(categorias[i].value);
